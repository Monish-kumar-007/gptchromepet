...
const placementStats = [
  ...
  },
  {
    ...
    value: "50+",
    description: "Recruiting organizations",
    icon: Building2,
  },
  {
  ...
  },
  {
    ...
    value: "₹8 LPA",
    description: "Maximum offer received",
    icon: Star,
  },
];
...
const placementProcess = [
  {
    ...
    title: "Registration",
    description:
      "Students register with placement cell and submit required documents",
    icon: Users,
  },
  {
    step: 2,
    ...
    description:
      "Aptitude training, soft skills development, and interview preparation",
    icon: Target,
  },
  {
    step: 3,
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            Bridging the gap between education and employment, ensuring
            successful career launches for our graduates
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          {placementStats.map((stat, index) => (
            <Card
              key={index}
              className="hover:shadow-lg transition-all duration-300 border-2 hover:border-green-200 dark:hover:border-green-700 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm"
            >
              ...
              <TabsContent value="overview" className="space-y-8">
                ...
                <div className="text-center mb-8">
                  ...
                  <p className="text-lg text-gray-700 dark:text-gray-300 italic max-w-4xl mx-auto leading-relaxed">
                    "To provide comprehensive training, guidance, and support to
                    students, enhancing their employability and securing
                    successful placements in leading organizations."
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                  <div className="space-y-6">
                    ...
                    <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                      Every diploma student aspires to work for a renowned
                      organization. It is evident from considering this
                      important issue that diploma students require training to
                      enhance their career prospects and secure respectable
                      employment in a variety of industries.
                    </p>
                    <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                      At our college, students not only receive technical
                      instruction but are also cultivated into well-rounded
                      persons with life skills to address global issues. In
                      order to provide career opportunity to our students we are
                      having a Placement Cell, which is effectively functioning
                      in our Institution with a Placement Officer and Placement
                      coordinators to achieve consistently high placement rates.
                    </p>
                  </div>
              ...
              <TabsContent value="process" className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                  {placementProcess.map((step, index) => (
                    <Card
                      key={index}
                      className="relative hover:shadow-lg transition-all duration-300 border-2 border-gray-200 dark:border-gray-700 hover:border-green-300 dark:hover:border-green-600"
                    >
                      <CardContent className="p-6 text-center">
                ...
                <div className="mt-12 bg-gradient-to-br from-green-50 to-blue-50 dark:from-green-900/20 dark:to-blue-900/20 p-8 rounded-lg border border-green-200 dark:border-green-800">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 text-center mb-6">
                    Join our placement program and let us help you achieve your
                    career goals
                  </p>
          ...
          <CardContent className="p-8">
            <div className="text-center mb-6">
              ...
              <p className="text-green-100">
                Contact our placement team for any queries or assistance
              </p>
            </div>
