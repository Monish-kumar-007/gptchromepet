...
export default function Index() {
  const featuredCourses = [
    {
      ...
      description:
        "Advanced programming, software development, and system design",
      icon: "💻",
      duration: "3 Years",
      intake: "60 Students",
    ...
    },
    {
      ...
      description:
        "Modern electronics, communication systems, and embedded technology",
      icon: "📡",
      duration: "3 Years",
      intake: "60 Students",
    ...
    },
    {
      ...
      description:
        "Power systems, control engineering, and electrical machines",
      icon: "⚡",
      duration: "3 Years",
      intake: "60 Students",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-blue-900 relative overflow-hidden">
      ...
      <div
        className={
          'absolute inset-0 bg-[url(\'data:image/svg+xml,%3Csvg width="60" height="60" viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"%3E%3Cg fill="none" fill-rule="evenodd"%3E%3Cg fill="%233b82f6" fill-opacity="0.03"%3E%3Ccircle cx="30" cy="30" r="2"/%3E%3C/g%3E%3C/g%3E%3C/svg%3E\')]'
        }
      ></div>
            ...
            <div className="space-y-8 fade-in-up">
              <div className="space-y-4">
                <div className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-blue-100 to-purple-100 dark:from-blue-900/30 dark:to-purple-900/30 rounded-full mb-6">
                  ...
                  <span className="text-sm font-medium text-gray-700 dark:text-gray-300">
                    Established 1992 • Government Institution
                  </span>
                </div>
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <Link to="/departments">
                  <Button
                    variant="outline"
                    size="lg"
                    className="border-2 border-blue-600 text-blue-600 hover:bg-gradient-to-r hover:from-blue-50 hover:to-purple-50 dark:hover:from-blue-900/20 dark:hover:to-purple-900/20 transform hover:scale-105 transition-all duration-300"
                  >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                {highlights.map((highlight, index) => (
                  <div
                    key={index}
                    className="flex items-center space-x-3 p-3 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-lg shadow-md hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1"
                  >
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              <div key={index} className="text-center group">
                <div
                  className={`inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-white to-gray-100 dark:from-gray-700 dark:to-gray-800 rounded-2xl mb-4 shadow-lg group-hover:shadow-xl transform group-hover:scale-110 transition-all duration-300`}
                >
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl">
            <div className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed space-y-6">
              <p>
                Government Polytechnic College, Chromepet-Chennai (Formerly
                Institute of Road Transport Polytechnic College, Chennai) was
                started by the Institute of Road Transport, Taramani in the year
                1992-93. Three Polytechnics in Chennai, Bargur, and Tirunelveli
                were started with the idea of imparting Technical Education to
                the wards of the Transport Corporation employees.
              </p>
              <p>
                The Polytechnic functions in the campus with an area of 17.35
                acres. Education is all about creating an environment of
                academic freedom, where bright minds meet, discover and learn.
                One would experience top of the world living and learning
                experience at Government Polytechnic College.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              Discover our comprehensive engineering programs designed to
              prepare students for successful careers in technology and
              innovation.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {featuredCourses.map((course, index) => (
              <Card
                key={index}
                className="group hover:shadow-2xl transition-all duration-500 border-0 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm hover:-translate-y-2 overflow-hidden"
              >
                <div
                ...
                <CardContent className="space-y-4">
                  ...
                  <Button
                    className={`w-full bg-gradient-to-r ${course.gradient} hover:opacity-90 transform hover:scale-105 transition-all duration-300 text-white shadow-lg`}
                  >
                    Learn More
                  </Button>
                </CardContent>
